...
<meta charset="UTF-8">
    ...
    <title>Nota Laporan Produksi - Balai Usaha Perikanan Genteng</title>
...
<body>
    ...
    <nav>
        ...
        <main>
            <div class="content">
                <h2>Upload Nota Penjualan</h2>
                <div class="upload-form">
                    @if(session('success'))
                        <div class="alert alert-success">
                            {{ session('success') }}
                            <br>
                            <a href="{{ asset('storage/' . session('file')) }}" target="_blank">Lihat File</a>
                        </div>
                    @endif
                    ...
                    <form action="{{ route('nota.upload') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="file">Pilih File Nota:</label>
